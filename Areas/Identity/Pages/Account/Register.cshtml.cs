...
namespace Entity.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IUserStore<EntityUser> userStore,
        ...
        private EntityUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(EntityUser)}'. " +
                    $"Ensure that '{nameof(EntityUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
